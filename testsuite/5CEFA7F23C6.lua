...
FUs.AddSub = { Latencies = { 0.835 / PERIOD, 1.772 / PERIOD, 2.008 / PERIOD, 2.495 / PERIOD, 3.435 / PERIOD }, --Add
               Costs = {0 * 64, 0 * 64, 0 * 64, 0 * 64, 0 * 64}, --Add
               StartInterval=1,
			         ChainingThreshold = ADDSUB_ChainingThreshold}
FUs.Shift = { Latencies = { 0.744 / PERIOD, 1.766 / PERIOD, 2.422 / PERIOD, 3.066 / PERIOD, 3.955 / PERIOD }, --Shift
			        Costs = {0 * 64, 0 * 64, 0 * 64, 0 * 64, 0 * 64}, --Shift
              StartInterval=1,
