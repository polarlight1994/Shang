...
class VASTSeqOp : public VASTOperandList, public VASTNode,
  ...
  PointerIntPair<Instruction*, 1, bool> Inst;
...
public:
  VASTSeqOp(VASTSlot *S, bool UseSlotActive, Instruction *Inst,
  ...
  //
  Instruction *getInst() const { return Inst.getPointer(); }
  bool isVirtual() const { return Inst.getInt(); }
