...
// 		                             Value *Cnd, SIR *SM, SIRCtrlRgnBuilder &Builder);
// 	};
// }
// 
...
// 	// Initialize a SIRCtrlRgnBuilder to build assignment for SlotReg
// 	SIRCtrlRgnBuilder Builder(&SM, TD);
// 
...
// 
// 	Builder.assignToReg(SrcSlot, Cnd, SM->createIntegerValue(1, 1), DstSlot->getSlotReg());
// 
