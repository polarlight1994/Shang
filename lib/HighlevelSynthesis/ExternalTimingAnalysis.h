...
class ExternalTimingAnalysis {
  ...
  void extractTimingForPair(raw_ostream &O, const VASTRegister *Dst,
                            const VASTValue *Thu,
                            const VASTRegister *Src) const;

  void extractTimingToDst(raw_ostream &O, const VASTRegister *Dst,
